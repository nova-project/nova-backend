...
@Data
@ApiType(name = "User", description = "A user is a person who interacts with the app. It is also used to store who has access to content or who created it, e.g. settings or authored texts.")
