...
public class InjectionHandler {
    ...
    public void createBindings(final Stage stage) {
        if (this.injector == null) {
            ...
            throw new IllegalStateException("The bindings are already created. Use "
                    + InjectionHandler.class.getName() + ".recreateBindings() instead.");
        }
    }
    ...
    public void recreateBindings() {
        if (this.injector != null) {
            ...
            throw new IllegalStateException("The bindings has to be created first by "
                    + InjectionHandler.class.getName() + ".createBindings(" + Stage.class.getName() + ").");
        }
    }
}
